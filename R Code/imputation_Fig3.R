#################################################################################
# This is the 4th of 5 scripts to complete the analyses in Wolfe and Stull 2024.#
# The following script imports posterior samples from a fit Stan model and      #
# prepares Figure 3. To do so, we use CmdStanR's Generated Quantities argument  #
