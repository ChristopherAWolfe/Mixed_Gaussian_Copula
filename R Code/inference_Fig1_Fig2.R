#################################################################################
# This is the 3rd of 5 scripts to complete the analyses in Wolfe and Stull 2024.#
# The following script imports posterior samples from a fit Stan model and      #
# prepares Figure 1 and Figure 2. A second file 'response_vars.csv' contains    #
...
### PCA
pc_diaphyseal <- princomp(cmat_diaphyseal)

### Figure 2B
fviz_pca_ind(pc_diaphyseal, repel = T, title="")

## 2C-2D: Skeletal Development
...
### PCA
pc_skel_dev <- princomp(cmat_skel_dev)


### Figure 2D
fviz_pca_ind(pc_skel_dev, repel = T, title="")


## 2E-2F: Dental Development
...
### PCA
pc_dental_dev <- princomp(cmat_dental_dev)

### Figure 2F
fviz_pca_ind(pc_dental_dev, repel = T, title="")
