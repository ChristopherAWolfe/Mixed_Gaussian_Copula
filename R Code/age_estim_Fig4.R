#################################################################################
# This is the 5th of 5 scripts to complete the analyses in Wolfe and Stull 2024.#
# The following script imports posterior samples from a fit Stan model and      #
# prepares Figure 4. To do so, we use Slice Sampling to draw posterior samples  #
# of age to complete age estimation. We compare these results to the MCP        #
